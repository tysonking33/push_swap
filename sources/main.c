...
/*   Updated: 2022/12/08 14:06:44 by tytang           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if ((array->a_size == 1) && (check_sorted(array) == 0))
		swapa(array);
	else if ((array->a_size == 2) && (check_sorted(array) == 0))
		small_med_large(array);
	else if ((array->a_size == 4) && (check_sorted(array) == 0))
		five_sort(array);
	else if ((array->a_size >= 3) && (check_sorted(array) == 0))
		large_sort2(array);
}
